...
if CoreGUI:FindFirstChild("53637265656e4775690d0a") then
  loadstring(game:HttpGet("https://raw.githubusercontent.com/water5202/Notifications/refs/heads/main/FPSDISPLAYNOTIFICATION2.lua"))()
	return
else
  loadstring(game:HttpGet("https://raw.githubusercontent.com/water5202/Notifications/refs/heads/main/FPSDisplayNotificationMain.lua"))()
end
